                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li class="page-item custom-page-digits active"><span class="page-link shadow">{{ $page }}</span></li>
                        @else
                            <li class="page-item custom-page-digits"><a href="{{ $url }}" class="page-link shadow">{{ $page }}</a></li>
                        @endif
                    @endforeach
                @endif
            @endforeach
