			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
				<div class="card">
					<div class="c-wraper">
						...
						<p>Total Memberships Purchased</p>
					</div>
				</div>
			</div>
						...
						<table id="usersTable" class="align-middle mb-0 table table-borderless table-striped table-hover">
							...
							@foreach ($users as $user)
								<tr>
											...
											<div class="widget-content-wrapper">
												<div class="widget-content-left mr-3">
													<div class="widget-content-left">
														<img class="rounded-circle" src="@if($user->user_file){{ asset('storage/'. $user->user_file) }}@else{{ 'https://ui-avatars.com/api/?size=128&background=645bd3&color=fff&name='. $user->name }} @endif" alt=""
															 height="40" width="40">
													</div>
												</div>
									...
									<td class="text-center">{{ number_format($user->ad_power_balance(), 0, '.', ',') }}</td>
