                            ...
                            <div class="r-f-b">
                                <div class="referrals-img-section">
                                    <div class="referrals-img-img">
                                        <img src="@if($directReferral->user_file){{ asset('storage/'.$directReferral->user_file) }}@else{{ asset('assets/images/avatars/referrals-user-img.png') }} @endif">
                                    </div>
                                </div>
                                <div class="hu-097vbf">
                                    <div class="hu-67487">
                                    ...
                                    <div class="referrals-box-user-detail">
                                        ...
                                        <div class="referrals-user-info">{{ $directReferral->membership($directReferral->id)->name }}</div>
                                    </div>
                                    <div class="referrals-box-user-detail">
